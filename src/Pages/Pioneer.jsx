...
export default function Pioneer() {
    ...
    return (
            ...
            <div>
                ...
                <p>We found that some capicitors needed to be recapped, and knowing how leaky capicitors of this age can impact the sound quality, we gave the repair option to the customer.</p>
                <p>They were happy with our thorough evaluation and communication. So after we had the go ahead, we finished the unit before bench testing.</p>
